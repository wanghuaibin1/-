<template>
  ...
  <div class=" max-w-[1800px] h-[87vh] relative m-auto">
    <img class="w-full h-full absolute" src="https://bpic.588ku.com/back_origin_min_pic/19/07/03/0bd5195aa6d3afb3d2a99019e8098877.jpg!/fw/750/quality/99/unsharp/true/compress/true" alt="">
    <div class=" absolute top-12 right-56 py-3 sm:max-w-xl sm:mx-auto">
      <div class="relative px-4 py-10 bg-[rgba(255,255,255,.8)] mx-8 md:mx-0 shadow rounded-3xl sm:p-10">
        <div class="max-w-md mx-auto ">
          <div class="flex items-center space-x-5 justify-center text-xl">
            登录
          </div>
          <div class="mt-5">
            <label class="font-semibold text-sm text-gray-400 pb-1 block" for="login">用户名</label>
            <input v-model="state.userName"
              class="border rounded-lg !p-3 h-[40px] py-2 mt-1 mb-5 text-lg w-full bg-gray-700 text-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500"
              type="text" id="login" />
            <label class="font-semibold text-sm text-gray-400 pb-1 block" for="password">密码</label>
            <input v-model="state.password"
              class="border rounded-lg !p-3  h-[40px] py-2 mt-1 mb-5 text-sm w-full bg-gray-700 text-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500"
              type="password" id="password" />
          </div>
          <div class="text-right mb-4">
            <a class="text-xs font-display font-semibold text-gray-500 hover:text-gray-400 cursor-pointer" href="#">
              忘记密码?
            </a>
          </div>
              ...
              <button
                ...
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="25" height="25" viewBox="0 0 24 24">
                  ...
                  <path
                    ...
                    opacity=".1"></path>
                  <polygon points="12,14.25 12,14.5 18.4862061,14.5 18.587492,14.25" opacity=".1"></polygon>
                  <path fill="#E6E6E6"
                  ...
                  <linearGradient id="LxT-gk5MfRc1Gl_4XsNKba_xoyhGXWmHnqX_gr1" x1="0" x2="24" y1="12" y2="12"
                    gradientUnits="userSpaceOnUse">
                    <stop offset="0" stop-color="#fff" stop-opacity=".2"></stop>
                    <stop offset="1" stop-color="#fff" stop-opacity="0"></stop>
                  </linearGradient>
                  <path fill="url(#LxT-gk5MfRc1Gl_4XsNKba_xoyhGXWmHnqX_gr1)"
                ...
                <span class="ml-8">Google 登录</span>
              </button>
              <button
          ...
          <div class="flex items-center justify-between mt-4">
            ...
            <a class="text-xs text-gray-500 uppercase dark:text-gray-400 hover:underline" href="#"
              @click="$router.push('/logon')">注册</a>
            <span class="w-1/5 border-b dark:border-gray-600 md:w-1/4"></span>
          </div>
        </div>
      </div>
