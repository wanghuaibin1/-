<template>
  <main class="grid min-h-full place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8">
    <div class="text-center">
      ...
      <p class="mt-6 text-base leading-7 text-gray-600">很抱歉，我们找不到您要查找的页面。</p>
      <div class="mt-10 flex items-center justify-center gap-x-6">
        ...
        <a href="#" class="text-sm font-semibold text-gray-900">联系技术支持<span aria-hidden="true">&rarr;</span></a>
      </div>
    </div>
  </main>
</template>
